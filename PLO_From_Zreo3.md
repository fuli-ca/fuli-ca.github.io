...
为了练习在战略建模中使用翻牌权益分布数据，我们现在将对 3 种不同类型的 PLO 起手牌对抗 AAxx 的可玩性进行简单研究。我们将使用一个简单的模型，假设我们的对手完全投入 AAxx，并且他会抓住任何机会下注和加注，直到我们全压。
...
- ![9s](p/9s.jpg) ![8h](p/8h.jpg) ![7S](p/7s.jpg) ![6h](p/6h.jpg) （双同花完美连牌）
- ![As](p/As.jpg) ![Kh](p/Kh.jpg) ![QS](p/Qs.jpg) ![Td](p/Td.jpg)  （单同花百老汇包牌）
- ![Ks](p/9s.jpg) ![Kh](p/Kh.jpg) ![7d](p/7d.jpg) ![2c](p/2c.jpg)  （KK带没有价值的边牌）

我们将让这些牌在单次加注底池、3-bet 底池和 4-bet 底池中与 AAxx 相遇，起始筹码为 100 BB。我们的对手将用 AAxx 全力投入，并且他会抓住一切机会下注和加注，直到我们全压。对于每种情况我们将计算从翻牌前将第一枚筹码放入底池那一刻起玩我们手牌的 EV。

**对手的策略**

对手的策略是抓住一切机会下注和加注他的 AAxx 牌，直到我们全压。
...
我们的问题是，我们找不到足够的翻牌来压注，而不得不在大多数翻牌上弃牌会越来越伤害我们（如果你研究一下图表，你会发现，在所有情况下，我们都压注了前 15% 的翻牌，这意味着当我们从加注底池转移到 4-bet 底池时，我们找不到任何可以压注的翻牌）。
...
然后我们有一个有利可图的跟注，底池中已经有很多筹码，并且这手牌很容易在翻牌后大底池中玩好。我们的模型告诉我们，选择用 ![9s](p/9s.jpg) ![8h](p/8h.jpg) ![7s](p/7s.jpg) ![6h](p/6h.jpg) 玩 4-bet 底池对抗 AAxx 是一种略微失败的玩法，但在实践中，我们将从跟注 4-bet 中获利，计划在我们击中足够好时在翻牌上投入。我们将在第 4 部分中更详细地讨论这种情况。

但是，如果我们用 ![As](p/As.jpg) ![Kh](p/Kh.jpg) ![Qs](p/Qs.jpg) ![Td](p/Td.jpg) 或 ![Ks](p/Ks.jpg) ![Kh](p/Kh.jpg) ![7d](p/7d.jpg) ![2c](p/2c.jpg) 被 4-bet，我们应该用 100 BB 筹码弃牌。在我们的模型中，这些牌是 4-bet 底池中的大输家，如果我们从 4-bet 的点计算 EV，它们也将是输家。
...
对抗 AAxx 时表现最好的牌之一！（对抗 AAxx 时表现最好的牌是没有间隙的双花色优质连牌）。

因此，我们测试了“4-bet 并全压任何翻牌”策略，以对抗 AAxx 可能遇到的最差牌之一，并且拥有完美的玩法，而对手仍然可以用他的 AAxx 盲目全压任何翻牌而不会输钱。

基于这项模型研究，我们可以得出结论：

*如果您可以在单挑的情况下将至少 1/3 的起始筹码放入翻牌前底池（这样您在翻牌时最多剩下 1 个底池大小的下注），您可以在任何翻牌时全押，如果您愿意，您的对手无法利用这一点。*

例如，假设您以 100 BB 开始并在不利位置 ![Ah](p/Ah.jpg) ![Ad](p/Ad.jpg) ![7c](p/7c.jpg) ![2h](p/2h.jpg) 加注底池。您的对手 3-bet 底池，您 4-bet 底池，对手跟注。翻牌 ![Ts](p/Ts.jpg) ![9s](p/9s.jpg) ![8c](p/8c.jpg) 非常可怕且协调一致，您不确定是否要全压。

您无论如何都可以全压。我们已经证明，在任何翻牌上全压最后一次下注都不会对您造成伤害。可能有更好的玩牌方式，但在 4-bet 底池中盲目全压，起始筹码为 100 BB，对手无法利用这一点。
