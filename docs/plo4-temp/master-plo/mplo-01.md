...
理解实现权益的概念将使你成为更强大的玩家。它是一个数学概念，是所有扑克行动和策略的基础。在 PLO 中，这个概念尤为重要，因为游戏中的牌型权益非常接近。你可能会想，如果权益如此接近，为什么玩家在实现权益方面会遇到困难？这正是 PLO 中的问题所在。在德州扑克中，如果你弃掉一手弱牌，通常只会损失一小部分底池，通常为 20% 或更少。在 PLO 中，即使是你认为是垃圾牌，与给定的底池赔率相比，也可能拥有巨大的权益。
