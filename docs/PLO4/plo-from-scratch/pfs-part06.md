...
你（$10）持有 A♠K♥K♠J♥ 在 CO 加注到 3.5 BB，BTN（$15.20）3-bet 到 12 BB，其他对手弃牌。你只与 BTN 打了 60 手牌，但你已经看到他在有利位置用投机牌 3-bet 4 次，并打到摊牌。你怀疑他用宽范围的牌投机 3-bet 和诈唬 3-bet。你的计划是什么？
...
你凭借坚果同花获胜。BTN 是 T♥9♦8♥6♥。他翻牌击中了两对，在转牌时改进为顺子，但输给了我们的后门同花。
...
现在，假设我们遇到一个非常松散激进的玩家， BTN 的 3-bet% 为 12%。根据上述范围分析，我们知道他的范围必须包含大量中 / 低质量的牌。例如，质量一般的连牌 T♣8♣6♠5♠。
...
在这种情况下，优质高牌（例如 K♠K♥Q♠Q♥、A♠K♦K♠J♦、A♠K♥Q♠J♥）的权益将增加，原因有两个：

- 我们很少对抗 A-A-x-x
- 我们对抗对手的非 A-A-x-x 牌有很好的权益

后者基于这样一个事实：当对手持有一些中 / 低手牌（例如 9♠8♥6♦4♠）时，我们的高对子的表现几乎与 A-A-x-x 一样好。

例如，对手持有 9♠8♥6♦4♠ 对抗 A-A-x-x 的权益为 40.32%，对抗 K-K-x-x 的权益为 39.84%，因此当我们 4-bet 时，持有哪手牌并不重要。
...
你（$10）在 CO 用宽范围开池加注到 $0.35，BTN（$10）用 J♠9♥7♣6♠ 3-bet 到 $1.20。你 4-bet 到 $3.75。对手现在认为他面对的是 A-A-x-x，他可以轻松跟注，手牌是一手不错的同花连牌（在本文后面我们将看到为什么这是自动跟注）。
...
第 2 点显然是正确的，因为我们现在通常会与另一个 A-A-x-x 进行翻硬币）。我们可能在垃圾牌 A-A-x-x 上处于劣势（例如，垃圾牌 A♠A♥7♦2♣ 在与优质牌 A♦A♣K♦Q♣ 的对抗中处于 41.5% 劣势，但底池足够大，我们不必担心这一点。另外，请注意，我们很少 3-bet 垃圾牌 A-A-x-x，因此这种情况不太可能发生。

需要改进的是第 3 点。我们现在想找到以下问题的答案：

*哪些牌在对抗 A-A-x-x 时表现足够好，可以用 100 BB 筹码跟注可能的 A-A-x-x 的 4-bet？*

我们在第 4 部分中对这个主题做了一些一般性评论，我们假设我们想要同花和协调的牌经常击中翻牌。击中大量翻牌使我们经常能够在翻牌时可以 +EV 全押，从而获得翻牌前大笔投资的回报。类似这样的 9♠8♥7♠6♦ 同花连牌显然适合于此目的，但我们在这里还能玩什么其他牌？哪些牌绝对不能跟注 4-bet？
...
**6.3.3.1 优质双同花两对（K♠K♥Q♠Q♥）vs A-A-x-x**
...
**6.3.3.2 优质双同花 + 连张 K-K-x-x（K♠K♥Q♠J♥）vs A-A-x-x**
...
**6.3.3.3 优质双同花 + 连张 Q-Q-x-x（Q♠Q♥J♠T♥）vs A-A-x-x**
...
**6.3.3.4 优质双同花 + 连张 J-J-x-x（J♠J♥T♠9♥）vs A-A-x-x**
...
**6.3.3.5 优质双同花 A 高百老汇包牌（A♠K♥Q♠J♥）vs A-A-x-x**
...
最后，我们将通过计算上述所有单同花牌型的 EV 来研究双同花的影响。然后，我们将其中一张牌变成梅花（K♠K♥Q♠Q♣，K♠K♥Q♠J♣ 等），并进行另一轮翻牌权益分布模拟。
...
对于高对来说，拥有 2 种同花非常重要，你可以弃掉单同花的 K-K-x-x 和 Q-Q-x-x。但你可以用单同花和相连边牌的 J-J-x-x 及更低的对子牌跟注。我们不会默认 3-bet  7♠7♥6♠5♥ 那样低对，但有趣的是，这些对子对抗 A-A-x-x 的表现优于 K-K-x-x 和 Q-Q-x-x（因为顺子阻挡效应）。
...
**6.3.4.1 优质双同花连牌（9♠8♥7♠6♥）vs A-A-x-x**
...
**6.3.4.2 优质 A 双同花 + 连牌（A♠9♥8♠7♥）vs A-A-x-x**
...
**6.3.5.1 诈唬 3-bet 双同花（Q♠9♥6♠5♥）vs A-A-x-x**
...
CO（$10）加注到 $0.35。他很直接，在被 3-bet 后在不利位置打得很紧，因此你在 BTN 持有 J♥9♥7♠5♠ 选择投机 3-bet 到 $1.20。盲注弃牌，CO 4-bet 到 $3.75。
...
这次输了。对手摊牌 A♣A♦K♣9♣ 用顶暗三条拿下底池。我们对抗他的实际手牌有 35.98% 的权益，并且完美防御了他的翻牌前 4-bet。
...
CO（$17.20）加注到 $0.35。他很紧 / 稳健，在有利位置很容易通过 3-bet 击败他。你持有 J♦8♦5♠4♠ 评估情况并选择在 BTN 位置 3-bet 到 $1.20 进行诈唬。SB（$15.30）是一个稳健而直率的紧凶玩家，现在 4-bet 到 $4.05，CO 全押。你有什么计划？
...
你用翻牌击中底两对拿下底池。CO 是 A♦A♠K♠9♥，而 SB 是 A♥A♣8♥8♣。他们都痛苦地尖叫，CO 威胁要向管理人员举报你作弊。
