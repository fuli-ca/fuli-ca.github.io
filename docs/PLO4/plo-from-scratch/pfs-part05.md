...
例如，面对一个只用 A-A-x-x 3-bet、总是在翻牌单挑时 c-bet、下注 - 跟注加注过于频繁的对手，你可以用像 T♦️8♠️7♠️4♦️ 这样的牌跟注 3-bet，并在 J♠️T♠️6♥️ 翻牌上全押，而不会在对手跟注时感到恶心。你对抗随机 A-A-x-x 有 59% 的权益，并且你预计随机 A-A-x-x 会构成对手范围的大部分。
