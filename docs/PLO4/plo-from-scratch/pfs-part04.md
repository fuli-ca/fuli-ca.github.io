...
这使得 A♣️A♥️8♣️2♥️ 价值 3-bet 不太合适，因为当我们寻找翻牌来获利全押时，缺乏协调会给我们带来问题（记住：当你根据价值建立一个大的翻牌前底池时，拥有一手经常击中翻牌并足以继续的牌很重要）。
...
我们这里暂不做跟注 / 弃牌的决定，但我们会把这个例子带到第 5 部分，在那里找到答案。我们将使用 Q♠️9♥️6♠️5♣️ 对抗 A-A-x-x 的翻牌权益分布来决定跟注 4-bet 是否有利可图，然后在翻牌圈我们有足够的权益对抗 A-A-x-x 时全押。
...
与上面翻牌权益分布范围相反的例子，我们有优质、双同花的牌，例如 9♠️8♥️7♠️6♥️。这些牌通常会在翻牌击中不错的成手牌 + 听牌组合，让我们能够有利可图地跟注全押。从下面的翻牌权益分布图中，我们可以看到我们的权益现在分布均匀，而不是集中在少数前 x% 的翻牌上：
...
CO（$6.25）全押。我们 T♠️8♦️7♣️6♠️ 在这个翻牌上有足够的权益（至少31%）吗？
