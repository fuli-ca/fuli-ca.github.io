...
第一个原因，你可以让许多具有高权益的手牌弃牌，比如顺子听牌或顶对。第二个原因，即使被更好的牌跟注，你的手牌仍然有改进的空间。第三个原因在于，你持有一张特殊的阻断牌，可以通过在河牌圈扩大底池来充分发挥其作用。在几乎所有河牌上，A♥️ 仍然是一个有价值的阻挡牌，可以用来诈唬。
...
在开始讨论这个重要话题之前，我想澄清一点：我们讨论的不是低 SPR 的情况。我们已经提到，这些底池主要由权益驱动。在这些情况下，关键指标是全押数学。我们稍后会讨论这个话题。
