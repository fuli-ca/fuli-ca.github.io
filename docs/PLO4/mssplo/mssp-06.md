...
回想一下 J♠-10♠-9♣ 的翻牌面，在这种情况下，你在 CO 位置 4-bet 对抗 BTN 的 3-bet 后，应该只下注 20% 的时候。你会比 20% 更多地翻牌击中一些相当不错的手牌，比如带同花听牌的超对、强组合听牌、坚果顺子或三条。
...
第一个原因，你可以让许多具有高权益的手牌弃牌，比如顺子听牌或顶对。第二个原因，即使被更好的牌跟注，你的手牌仍然有改进的空间。第三个原因在于，你持有一张特殊的阻断牌，可以通过在河牌圈扩大底池来充分发挥其作用。在几乎所有河牌上，A♥ 仍然是一个有价值的阻挡牌，可以用来诈唬。
